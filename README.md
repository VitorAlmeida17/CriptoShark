...
Como Funciona:
O computador define uma frase complexa secreta e calcula seu hash SHA-256.
O hash é exibido para o usuário.
O usuário pode solicitar até 5 dicas para ajudar a deduzir a frase.
O usuário digita sua tentativa. O script calcula o hash da tentativa e o compara com o hash alvo.
...
Objetivo: Treinar um modelo para "aprender" a fórmula matemática 
Y
=
2
X
...
Como Executar:
Abra o arquivo ml.html em qualquer navegador web.
Abra o Console do Desenvolvedor (F12).
Observe o log de treinamento (a "perda" ou "loss" deve diminuir a cada época).
Ao final, o console exibirá a previsão do modelo para X=10 (o resultado esperado é ~19.0).
